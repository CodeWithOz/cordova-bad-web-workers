    ...
    ***************************************************************************** */
    ...
    class Events {
        ...
        eventListeners(type, el) {
            ...
            if (!Support.touch && Support.pointerEvents) {
                ...
                (_a = this.instance.backdropEl) === null || _a === void 0
                    ? void 0
                    : _a[type](
                ...
                if (Support.touch) {
                    ...
                    // Backdrop propagation fix
                    (_b = this.instance.backdropEl) === null || _b === void 0
                        ? void 0
                        : _b[type](
                              this.touchEvents.move,
                              this.touchMoveBackdropCb,
                ...
                if (
                    ...
                    // Backdrop propagation fix
                    (_c = this.instance.backdropEl) === null || _c === void 0
                        ? void 0
                        : _c[type](
                              'mousemove',
                              this.touchMoveBackdropCb,
        ...
        touchMove(t) {
            var _a;
            const { clientY, clientX, velocityY } = this.getEvetClientYX(
                t,
                'touchmove'
            );
            // Event emitter
            ...
            if (this.steps.length < 2) {
                ...
                if (velocityY < 1) {
                    newVal =
                        this.instance.getPanelTransformY() + diffY * velocityY;
                }
        ...
        onKeyboardShow(e) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                // calculate distances
                const currentHeight =
                    this.settings.breaks[this.breakpoints.prevBreakpoint]
                        .height;
                const inputEl = document.activeElement;
                const inputElBottomBound =
        ...
        handleTopperLowerPositions(coords) {
            ...
            if (!this.settings.inverse) {
                ...
                if (
                    ...
                    const screenDelta =
                        this.instance.screen_height -
                        this.instance.screenHeightOffset;
                    const differKoef =
    ...
    class Breakpoints {
        ...
        buildBreakpoints(conf, bottomOffset = 0, animated = true) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (this.settings.fitHeight) {
                    ...
                    conf.top.bounce =
                        (_b =
                            (_a = this.settings.breaks) === null ||
                            _a === void 0
                                ? void 0
                                : _a.top) === null || _b === void 0
                            ? void 0
                            : _b.bounce;
                    conf.bottom = ((_c = this.settings.breaks) === null ||
                    _c === void 0
                        ? void 0
                ...
                ['top', 'middle', 'bottom'].forEach(val => {
                    ...
                    if (this.settings.fitScreenHeight) {
                        if (
                            ((_a = this.settings.breaks[val]) === null ||
                            _a === void 0
                                ? void 0
                ...
                if (!this.instance.isPanePresented()) {
                    if (
                        !this.settings.breaks[this.settings.initialBreak]
                            .enabled
                    ) {
                        console.warn(
                ...
                if (this.instance.isPanePresented()) {
                    ...
                    if (
                        (_d = this.settings.breaks[this.prevBreakpoint]) ===
                            null || _d === void 0
                            ? void 0
                            : _d.enabled
                    ) {
                    ...
                    if (
                        !((_e = this.settings.breaks[this.prevBreakpoint]) ===
                            null || _e === void 0
                            ? void 0
                            : _e.enabled)
                    ) {
                    ...
                    this.instance.paneEl.style.top = this.settings.inverse
                        ? `-${this.bottomer - this.settings.bottomOffset}px`
                        : `unset`;
                    // Re-calc height
        ...
        getPaneFitHeight() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                let panePaddingBottom = parseInt(
                    document.defaultView
                        .getComputedStyle(this.instance.el.parentElement, '')
                ...
                __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (params.type === CupertinoTransition.Move) {
                        ...
                        if (this.instance.followerEl) {
                            this.instance.followerEl.style.transition =
                                'all 0ms linear 0ms';
                            this.instance.followerEl.style.transform = `translateY(${
                                params.translateY -
                    ...
                    if (
                        ...
                        if (this.settings.backdrop) {
                            if (
                                ...
                                this.instance.backdropEl.style.backgroundColor =
                                    'rgba(0,0,0,.0)';
                                ...
                                if (
                                    ...
                                    this.instance.backdropEl.style.display =
                                        'block';
                                    setTimeout(() => {
                        ...
                        let bounce =
                            nextBreak &&
                            ((_a = this.settings.breaks[nextBreak[0]]) ===
                                null || _a === void 0
                                ? void 0
                                : _a.bounce);
                        // style
                        this.instance.paneEl.style.transition =
                            this.buildTransitionValue(bounce);
                        // Bind for follower same transitions
                        if (this.instance.followerEl) {
                            this.instance.followerEl.style.transition =
                                this.buildTransitionValue(bounce);
    ...
    class ZStack {
        ...
        pushTransition(pushElement, newPaneY, transition) {
            ...
            const setStyles = (scale, y, contrast, border) => {
                ...
                let lastPushed = document.querySelector(
                    zStack[zStack.length - 1]
                );
                if (
                    !newPaneY &&
                    pushElement.className === lastPushed.className
                ) {
        ...
        getPushMulitplicator(el) {
            let multiplicator = el.style.getPropertyValue(
                '--push-multiplicator'
            );
    ...
    `;
                ...
                if (this.settings.followerElement) {
                    ...
                    this.followerEl.style.transition =
                        this.transitions.buildTransitionValue(
                            (_a = this.settings.breaks[this.currentBreak()]) ===
                                null || _a === void 0
                                ? void 0
                                : _a.bounce
                        );
        ...
        getPanelTransformY() {
            ...
            return parseFloat(
                translateYRegex.exec(this.paneEl.style.transform)[1]
            );
        }
        /************************************
         * Public user methods
        ...
        setZstackConfig(zStack) {
            ...
            this.settings.zStack = zStack
                ? Object.assign(
                      Object.assign({}, this.zStack.zStackDefaults),
                      zStack
                  )
                : null;
        }
        ...
        hide() {
            return __awaiter(this, void 0, void 0, function* () {
                if (!this.isPanePresented()) {
                    console.warn(
                        `Cupertino Pane: Present pane before call hide()`
                    );
                    return null;
                }
                if (this.isHidden()) {
